...
This vignette walks through each step with a synthetic panel of 6 subjects, each contributing 30 time points.
...
## Directed loop detection — `looping_machine()`
...
The return value contains the merged per-subject results and each leg's full `iarimax_results` object:
